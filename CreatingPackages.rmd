...
This document details how to create a package to upload to github.  The inspiration for this document is from the hilarypark link below.

There is a great blog on how to create a package that can be uploaded to a GitHub account.  This is found here:
...
It's time to learn to create and post my own R Scripts so I can reuse the code.  Several packages are necessary in order to do this.  The are:
...
Create a directory for the R Package
...
I found a useful file on the Internet called multiplot.r.  It allows for easy viewing plots in the same screen.
...
Setting up GitHub to house the Package created above:
